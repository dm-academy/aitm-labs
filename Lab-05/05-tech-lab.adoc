...
You should be using test-driven development however. An example of that follows.

Also feel free to visit the other teams and borrow anything interesting they have done.

REQUEST: At this writing, I would appreciate a basic Javascript approach that would allow the web site consumer to enter simple data (integers and strings), in a manner consumable by the supporting Java code.
