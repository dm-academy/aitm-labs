...
You have a limited budget. You cannot be able to fund all the requests.
...
|*High technical fit* |Re-evaluate with business partners; experiment |Explore new uses
...
** _The most important systems combine revenue dependency with high "heft"_
