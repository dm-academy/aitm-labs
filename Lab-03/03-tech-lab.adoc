...
....
YourStudentID@serverXXX:~$ git clone https://github.com/StThomas-serverXXX/Calavera.git
...
Instead, we are starting to use Chef. As mentioned in the  http://dm-academy.github.io/aitm/#_policy_based_approaches[readings for Session 02], Chef is a configuration management system. Now, a full treatment of Chef is beyond the scope of this class. However, you should look at a few things. You should still be in your Calavera directory. Run tree:
...
....
YourStudentID@serverXXX:~/Calavera$ vagrant ssh
...
....
YourStudentID@serverXXX:~/Calavera$ cat cookbooks/manos/recipes/default.rb
# manos-default
