...
When you are done with the official Docker tutorial through Part 3, run the https://docker-curriculum.com[Docker Curriculum] tutorial up to the section on Amazon. It covers some of the same material.
