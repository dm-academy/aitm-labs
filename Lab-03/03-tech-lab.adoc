...
Finally, work your way through the http://www.dwmkerr.com/learn-docker-by-building-a-microservice/[Building a Microservice] tutorial. This is a longer tutorial and I will be looking for feedback as to how useful it is.
...
If you are ambitious, you can do this on your laptop. You will need to https://docs.docker.com/install/[install Docker per the instructions]. Then continue with the tutorial through part 3. I do not recommend continuing with the Swarm or Compose material.
...
The final part of this lab: find another application or application stack to download and experiment with. Notify the instructor when you have it working and we may demo to the class. For 2 points extra credit, download https://github.com/dm-academy/aitm-labs[the labs Github repo] (which contain this page) and submit a pull request below containing the address of the app you downloaded.
...
* The original https://github.com/dm-academy/Calavera2/tree/master/manos["manos" concept from the Calavera platform], ported to Docker.
* https://github.com/dwmkerr/node-docker-microservice[node-docker-microservice] from the microservice tutorial.
