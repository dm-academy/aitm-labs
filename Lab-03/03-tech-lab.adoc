...
It will take several minutes to launch the new Vagrant instance.

Once the Vagrant launching process is complete, you can access your VM's web server. Manos comes preconfigured with a running Tomcat instance and a simple test-harness based Java application. You can see it running when you ssh into the VM:
...
You can also see the same thing from OUTSIDE your virtual machine. First, figure out your machine's IP address:

....
vagrant@manos1:~$ ifconfig
eth0      Link encap:Ethernet  HWaddr 08:00:27:c9:78:16
          inet addr:10.0.2.15  Bcast:10.0.2.255  Mask:255.255.255.0
          inet6 addr: fe80::a00:27ff:fec9:7816/64 Scope:Link
          UP BROADCAST RUNNING MULTICAST  MTU:1500  Metric:1
          RX packets:33747 errors:0 dropped:0 overruns:0 frame:0
          TX packets:13188 errors:0 dropped:0 overruns:0 carrier:0
          collisions:0 txqueuelen:1000
          RX bytes:26600608 (26.6 MB)  TX bytes:1117945 (1.1 MB)

eth1      Link encap:Ethernet  HWaddr 08:00:27:c9:26:30
          inet addr:172.28.128.3  Bcast:172.28.128.255  Mask:255.255.255.0
          inet6 addr: fe80::a00:27ff:fec9:2630/64 Scope:Link
          UP BROADCAST RUNNING MULTICAST  MTU:1500  Metric:1
          RX packets:2 errors:0 dropped:0 overruns:0 frame:0
          TX packets:19 errors:0 dropped:0 overruns:0 carrier:0
          collisions:0 txqueuelen:1000
          RX bytes:1180 (1.1 KB)  TX bytes:2210 (2.2 KB)
...
lo        Link encap:Local Loopback
          ...
          RX bytes:2497 (2.4 KB)  TX bytes:2497 (2.4 KB)

vagrant@manos1:~$ exit
....

The IP address (inet addr as labeled above) is on the eth1 interface (not eth0), so in the above case is 172.28.128.3.

....
test4@seis660:~/Calavera$ curl 172.28.128.3:8080/MainServlet
<h1>This is a skeleton application-- to explore the end to end Calavera delivery framework.</h1>
....
...
....
YourStudentID@serverXXX:~$ firefox -no-remote "YOUR_IP_ADDRESS:8080/MainServlet"
