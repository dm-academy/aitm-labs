...
** Part 1: you are running Docker in the cloud so you do not need to install it locally as these directions suggest.
** In general you run it *within* your container-optimized VM or VMs, within the Cloud Shell. 
