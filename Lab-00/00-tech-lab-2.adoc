...
Now that you have a functioning Linux instance, run the Linux tutorial. It's fine if you work on this during the week, but you need to have it completed by next week. The quiz will cover it, so do not take the quiz until you are done with the tutorial. 