...
You will need to launch Pageant every time you log in and give it your private key. I recommend keeping your private key on a USB stick, or other secure location.
