...
Start by logging into your personal server. You should be in `/home/vagrant`. Go
...
Fixed? Now you should be able to run the first scan as the lynis directions suggest. Lots of output that looks like:
...
Between these two resources you should be able to fix the issue. When you have, run the scan again and post evidence to Slack.
